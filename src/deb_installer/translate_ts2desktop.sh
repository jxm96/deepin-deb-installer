...
DESKTOP_TEMP_FILE=assets/deepin-deb-installer.desktop.tmp
DESKTOP_SOURCE_FILE=assets/deepin-deb-installer.desktop
DESKTOP_DEST_FILE=assets/deepin-deb-installer.desktop
